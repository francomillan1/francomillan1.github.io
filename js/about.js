    ...
    if (englishDescription) {
        description.innerHTML = `
            ...
            <h3>Hola mi nombre es Franco Nicolás Millán 👋</h4>
                ...
                <h3> Estoy interesado en la programación frontend y me especializo en Html, Css, JavaScript, Bootstrap, React. <br>
                     Manejo de motores de base de datos como PostgreSQL, MySQL, además tengo conocimientos en C#, Php, NodeJs y GIT.
                </h3>
        `
    } else {
        description.innerHTML = `
